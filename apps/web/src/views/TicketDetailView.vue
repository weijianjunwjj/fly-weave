    ...
    <template v-else-if="ticket">
      <header class="detail-header">
        ...
        <div class="primary-action">
          ...
          <a v-else-if="agentRun" :href="`#/agent-runs/${agentRun.business_key}`">查看 Agent Run →</a>
      ...
      <div class="content-grid">
        <main>
          ...
          <section class="panel">
            <header><span>03</span><div><h2>AI 处理</h2><p>AgentRun</p></div><a v-if="agentRun" :href="`#/agent-runs/${agentRun.business_key}`">查看 Agent Run →</a><b v-if="agentRun">{{ runLabel }}</b></header>
